    ...
    try:
                    ...
                    if text is None:
                        ...
                        if PrankBotsData.startswith(Abouts["10"]):
                          if D in Owner or D in meM:
                            ...
                            me.sendMessage(R, "teman sudah ditambah ya asv")
                        if PrankBotsData == Abouts["11"]:
                          if D in Owner or D in meM:
                            me.sendMessage(R, "dah lah")
                            PrankBots["Conection"] = R
                            Run_Xp()
                        ...
                        if PrankBotsData == Abouts["14"]:
                          if D in Owner or D in meM:
                            ...
                            me.sendMessage(R, "xxxxxRuntime bbyxxxxx\n [ {}".format(str(runtime)))
                        if PrankBotsData == Abouts["15"]:
                          if D in Owner or D in meM:
                            start = time.time()
                            me.sendMessage(R, "skuy..")
                        ...
                        if PrankBotsData == Abouts["17"]:
                          if D in Owner or D in meM:
                            ...
                            result += "\n Nama bapaknya : {}".format(contact.displayName)
                            result += "\n Mid : {}".format(contact.mid)
                            result += "\n Status : {}".format(contact.statusMessage)
                            result += "\n Foto monyetnya : http://dl.profile.line-cdn.net/{}".format(contact.pictureStatus)
                        ...
                        if PrankBotsData.startswith(Abouts["28"]):
                          if D in Owner or D in meM:
                            ...
                            tiktok = "https://www.tiktok.com/"+ key
                            me.sendMessage(R, "ini tiktoknya su\n" + tiktok)
                        ...
                        if PrankBotsData.startswith(Abouts["33"]):
                          if D in Owner or D in meM:
                            ...
                            groups = me.groups
                            for group in groups:
                                sendMessageWithFooter(group, "xxxxBroadCast by bbyxxxx\n{}".format(str(txt))+"\njangan lupa follow\ninstagram : https://instagram.com/anggarrev")
                        ...
                        if PrankBotsData == Abouts["45"]:
                          if D in Owner or D in meM:
                            if msg.toType == 2:
                                group = me.getGroup(R)
                                if group.preventedJoinByTicket == False:
                                    me.sendMessage(R, "udah kebuka cok")
                                else:
                                    group.preventedJoinByTicket = False
                                    me.updateGroup(group)
                        ...
                        if PrankBotsData == Abouts["46"]:
                          if D in Owner or D in meM:
                            if msg.toType == 2:
                                group = me.getGroup(R)
                                if group.preventedJoinByTicket == True:
                                    me.sendMessage(R, "udah tertutup cok")
                                else:
                        ...
                        if PrankBotsData == Abouts["62"]:
                          if D in Owner or D in meM:
                            if R in Sid['Red']:
                                ...
                                me.sendMessage(R, "aktifkan dulu cok")
                          ...
                          try:                          	
                              for mentionMembers in range(Dmem+1):
                                  ...
                                  for dataMention in group.members[mentionMembers*20 : (mentionMembers+1)*20]:
                                      ...
                                      no += 1
                                      ret_ += "\n. @!".format(str(no))
                                  ret_ += "\nxxxxxxxxxxx".format(str(len(dataMid)))
                        ...
                        if PrankBotsData.startswith(Abouts["75"]):
                          if D in Owner or D in meM:
                              if msg.toType == 2:
                                  ...
                                  if targets == []:
                                      me.sendMessage(R, "limit cok")
                                      bot1.sendMessage(R, "limit juga cok")
                                  else:
                                      for allmember in targets:
                                          ...
                                          me.sendMessage(R,"Member meninggul")
        if op.type == 26:
          if PrankBots["bot"] == True:
            msg = op.message
            text = msg.text
        ...
        if op.type == 19 or op.type == 32:
            ...
            if Chanell in PrankBots["PROTECT"]:
                if Penjahat in Acil:
                    ...
                    PrankBots["blacklist"][Penjahat] = True
                    print ("PROTECT NGAMUK "+me.getGroup(Chanell).name)
                    try:
                        bot1.kickoutFromGroup(Chanell,[Penjahat])
                    except:
        ...
        if op.type == 15:
            ...
            if PrankBots["Wc"] == True:
                ...
                mt = "Wah yang left meninggul {}".format(Gc.name)
            ...
            if PrankBots["Unsend"] == True:
                ...
                if Text_in_Destroy in msg_dict:
                    ...
                    if "text" in msg_dict[Text_in_Destroy]:
                        ...
                        sendMention(Geting, Target_Text.mid, "wah\naku kirim lagi cok unsent nya\n\n", str(rat_))
